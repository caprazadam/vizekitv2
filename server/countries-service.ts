...
export const serviceCountries: Omit<Country, 'id'>[] = [
  ...
  },
  {
    ...
    description: "Schengen vizesi gerekli - Hollanda konsolosluğundan vize almanız gerekmektedir",
    processingTime: "Vize başvurusu - 15-30 gün",
    fee: "8000₺",
    visaRequired: true,
    eVisaAvailable: false,
    visaOnArrival: false,
  },
  {
    ...
    description: "Schengen vizesi gerekli - İtalya konsolosluğundan vize almanız gerekmektedir",
    processingTime: "Vize başvurusu - 15-30 gün",
    fee: "8000₺",
    visaRequired: true,
    eVisaAvailable: false,
