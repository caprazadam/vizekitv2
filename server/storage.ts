  ...
  private initializeData() {
    ...
    const countriesData: Omit<Country, 'id'>[] = [
      ...
      },
      {
        ...
        code: "BA",
        flag: "🇧🇦",
        image: "https://cdn.pixabay.com/photo/2017/08/02/00/39/mostar-2571997_960_720.jpg",
      ...
      },
      {
        ...
        code: "MA",
        flag: "🇲🇦",
        image: "https://cdn.pixabay.com/photo/2016/02/19/10/56/morocco-1209393_960_720.jpg",
      ...
      },
      {
        ...
        code: "PH",
        flag: "🇵🇭",
        image: "https://cdn.pixabay.com/photo/2017/12/10/17/40/philippines-3010639_960_720.jpg",
      ...
      },
      {
        ...
        code: "FR",
        flag: "🇫🇷",
        image: "https://cdn.pixabay.com/photo/2013/10/01/10/29/eiffel-tower-190055_960_720.jpg",
        description: "Schengen vizesi gerekli - Hizmet ücretimiz: 8.000₺",
        processingTime: "Vize randevu hizmeti",
        fee: "8.000₺ (Hizmet ücreti)",
        visaRequired: true,
      ...
      },
      {
        ...
        code: "CA",
        flag: "🇨🇦",
        image: "https://cdn.pixabay.com/photo/2017/03/09/06/30/canada-2129409_960_720.jpg",
        description: "Vize gerekli - Hizmet ücretimiz: 8.000₺",
        processingTime: "Vize randevu hizmeti",
        fee: "8.000₺ (Hizmet ücreti)",
        visaRequired: true,
